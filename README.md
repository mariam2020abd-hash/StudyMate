...
الواجهتان تتضمنان صفحة تعريفية ولوحة طالب. يحفظ الموقع المقررات والشابترات والتقدم في المتصفح مع دعم التعديل والحذف. التطبيق ما يزال يستخدم بيانات تجريبية مؤقتة. لا توجد مزامنة بين الموقع والتطبيق.
